/**************************************************************************************************
  Filename:       timeapp.c
  Revised:        $Date: 2011-04-29 14:46:58 -0700 (Fri, 29 Apr 2011) $
...
#define ALERT_NOTIF_ENABLE_NEW                0x01    // Enable New Incoming Alert notification
#define ALERT_NOTIF_ENABLE_UNREAD             0x02    // Enable Unread Category Status notification
#define ALERT_NOTIF_NOTIFY_NEW                0x04    // Notify New Incoming Alert immediately
#define ALERT_NOTIF_NOTIFY_UNREAD             0x08    // Notify New Incoming Alert immediately
...
static const uint8 timeAppAlertCmd[] =
{
  ...
  ALERT_NOTIF_ENABLE_NEW | ALERT_NOTIF_ENABLE_UNREAD,
  ALERT_NOTIF_ENABLE_NEW | ALERT_NOTIF_ENABLE_UNREAD | ALERT_NOTIF_NOTIFY_NEW,
  ALERT_NOTIF_ENABLE_NEW | ALERT_NOTIF_ENABLE_UNREAD | ALERT_NOTIF_NOTIFY_UNREAD,
  0
};
