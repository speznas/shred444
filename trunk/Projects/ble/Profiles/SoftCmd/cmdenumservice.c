 ...
 * LOCAL FUNCTIONS
 */
static uint8 cmdEnumReadAttrCB( uint16 connHandle, gattAttribute_t *pAttr, 
...
bStatus_t CmdEnum_AddService( void )
{
  ...
  status = GATTServApp_RegisterService( cmdEnumAttrTbl, GATT_NUM_ATTRS( cmdEnumAttrTbl ),
                                        cmdEnumReadAttrCB, NULL, NULL );
