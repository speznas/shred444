/*******************************************************************************
  ...
  Revised:        $Date: 2011-02-17 12:57:07 -0800 (Thu, 17 Feb 2011) $
  Revision:       $Revision: 25120 $
...
/*******************************************************************************
 * @fn          HCI_TxDataBufferFree
 *
 * @brief       This function resets the transmit Data Buffers for given
 *              connection.
 *
 * input parameters
 *
 ...
 * @return      None.
 */
extern void HCI_TxDataBufferFree( uint16 connHandle );
