...
#define LL_STATUS_ERROR_VER_INFO_REQ_ALREADY_PENDING   0x1F // Unspecified Error
...
#define LL_ADV_DISCOVERABLE_UNDIRECTED_EVT             2
#define LL_ADV_NONCONNECTABLE_EVT                      3
...
#define LL_ADV_DIRECT_STATE                            0x03
...
#define LL_ADV_DIRECT_SCAN_PASSIVE_STATE               0x13
...
#define LL_ADV_DIRECT_SCAN_ACTIVE_STATE                0x17
//
...
//
#define LL_EXT_DISABLE_DELAY_POST_PROC                 0
#define LL_EXT_ENABLE_DELAY_POST_PROC                  1
//
...
#define LL_ADV_RPT_ADV_DISCOVER_IND                    LL_ADV_DISCOVERABLE_UNDIRECTED_EVT
#define LL_ADV_RPT_ADV_NONCONN_IND                     LL_ADV_NONCONNECTABLE_EVT
#define LL_ADV_RPT_SCAN_RSP                            (LL_ADV_NONCONNECTABLE_EVT + 1)
...
/*******************************************************************************
 * @fn          LL_EXT_DelayPostProc Vendor Specific API
 *
 * @brief       This function is used to enable or disable delaying post
 *              processing.
 *
 * input parameters
 *
 * @param       control - LL_EXT_ENABLE_DELAY_POST_PROC,
 *                        LL_EXT_DISABLE_DELAY_POST_PROC
 *
 * output parameters
 *
 * @param       None.
 ...
 * @return      LL_STATUS_SUCCESS, LL_STATUS_ERROR_BAD_PARAMETER
 */
extern llStatus_t LL_EXT_DelayPostProc( uint8 control );
 ...
 *
 * @brief       This function is used to to set the max RF TX power to be used
