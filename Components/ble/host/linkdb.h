/**************************************************************************************************
  Filename:       linkdb.h
  Revised:        $Date: 2010-09-15 16:47:35 -0700 (Wed, 15 Sep 2010) $
  Revision:       $Revision: 23813 $
...
typedef struct
{
  ...
  uint8 connInterval;      // The connection's interval (n * 1.23 ms)
 ...
 */
  ...
  extern uint8 linkDB_Add( uint8 taskID, uint16 connectionHandle, uint8  stateFlags, 
                          uint8 addrType, uint8 *pAddr, uint8 connInterval );
